...
// };
/**
 * Підключає Laravel File Manager до елементів без jQuery.
 * @param {string|NodeList|HTMLElement|HTMLElement[]} elements - селектор або вузли
 * @param {{type?: 'file'|'image', prefix?: string}} options
 */
