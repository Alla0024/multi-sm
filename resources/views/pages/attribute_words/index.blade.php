...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <div class="title-head">{!!  $word['attribute_words'] !!}</div>
                    <div class="count-elements">Вього елементів: {{$attributeWords->total()}}</div>
                </div>
                <div class="col-sm-2">
                ...
                <div class="col-sm-2 action-item">
                    ...
                    {!! Form::open(['route' => ['attributeWords.destroy', ''], 'method' => 'delete', '@submit.prevent = $store.page.deletedItems($event.target)']) !!}
