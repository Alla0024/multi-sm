...
@section('content')
    <section class="content-header edit-container">
        @include('components.basic.head-form', ['data' => $bankProgram])
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($bankProgram, ['route' => ['bankPrograms.update', $bankProgram->id], 'method' => 'patch']) !!}
            ...
            <div class="card-body">
                ...
                <div class="row card-items">
                    @include('pages.bank_programs.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('bankPrograms.index') }}" class="btn btn-default"> {{ $word['cancel'] }}</a>
            </div>
