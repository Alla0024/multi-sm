...
@section('content')
    <section class="content-header edit-container">
        @include('components.basic.head-form', ['data' => $bonusProgram])
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($bonusProgram, ['route' => ['bonusPrograms.update', $bonusProgram->id], 'method' => 'patch']) !!}

            <div class="card-body">
                <ul class="nav nav-tabs" id="customTabs">
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="main">Основна інформація</button>
                    </li>
                    <li class="nav-item">
