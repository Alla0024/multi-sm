                    ...
                    <th>
                        <div class="input-block input-toggle flex">
                            <div class="form-check form-switch">
                                <input class="form-check-input checkbox-child" data-content="{{  $category['id']}}" name="input-toggle_{{ $category['id']}}" type="checkbox" role="switch" id="switchCheckChecked_{{ $category['id']}}">
                            </div>
                        </div>
                    </th>
