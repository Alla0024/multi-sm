                            ...
                            @if($index != 'id' && $field['inTable'])
                                <th class="" @if($index == 'status' || $index == 'article')style="width: 132px" @endif>
                                    @if(isset($field['searchable']) && $field['searchable'])
                                        ...
                                        @elseif($index == 'sort_order' || $index == 'bank_id')
                                            <div>
                                ...
                                @if($index == 'sort_order')
                                    <th>
                                        <div class="search-name-input">Оплата</div>
                                    </th>
                                @endif
                            @endif
                        @endforeach
                ...
                <tr>
                    ...
                    @foreach($fields as $index => $field)
                        ...
                        @elseif($index == 'bank_id')
                            <td>{{$individualEntrepreneur['bank']['description']['name']}}</td>
                        @else
                             @if($index != 'id' && $field['inTable'])
