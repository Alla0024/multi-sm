...
@section('content')
    <section class="content-header create-container">
        @include('components.basic.head-form', ['data' => $newsletter ?? null])
    </section>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row card-items">
                    @include('pages.newsletters.fields')
                </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('newsletters.index') }}" class="btn btn-default">{{ $word['cancel'] }}</a>
            </div>
