...
@section('content')
    <section class="content-header create-container">
        @include('components.basic.head-form', ['data' => $notification ?? null])
    </section>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row card-items">
                    @include('pages.notifications.fields')
                </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('notifications.index') }}" class="btn btn-default">{{ $word['cancel'] }}</a>
            </div>
