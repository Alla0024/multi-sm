...
@section('content')
    <section class="content-header edit-container">
        @include('components.basic.head-form', ['data' => $paymentMethod])
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($paymentMethod, ['route' => ['paymentMethods.update', $paymentMethod->id], 'method' => 'patch', 'novalidate']) !!}
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('paymentMethods.index') }}" class="btn btn-default"> {{ $word['cancel'] }}</a>
            </div>
