...
@section('content')
    <section class="content-header edit-container">
        @include('components.basic.head-form', ['data' => $postcode])
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($postcode, ['route' => ['postcodes.update', $postcode->id], 'method' => 'patch', 'novalidate']) !!}
            ...
            <div class="card-body">
                ...
                <div class="row card-items">
                    @include('pages.postcodes.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('postcodes.index') }}" class="btn btn-default"> {{ $word['cancel'] }}</a>
            </div>
