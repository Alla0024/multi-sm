...
@section('content')
    <section class="content-header edit-container">
        @include('components.basic.head-form', ['data' => $productReview])
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($productReview, ['route' => ['productReviews.update', $productReview->id], 'method' => 'patch', 'novalidate']) !!}
            ...
            <div class="card-body">
                ...
                <div class="row card-items">
                    @include('pages.product_reviews.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('productReviews.index') }}" class="btn btn-default"> {{ $word['cancel'] }}</a>
            </div>
