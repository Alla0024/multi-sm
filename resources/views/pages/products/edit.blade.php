        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs" id="customTabs">
                    ...
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="images">Зображення</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="video">Відео</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="options">Опції</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="instructions">Інструкції</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="similar">Схожі товари</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="count">Кількість товарів</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="filling">Наповнення</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="img_category">Картинки в карточці категорії</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link active" type="button" data-tab="credit">Доступні кредити</button>
                    </li>
                </ul>
