        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-2 action-item">
                    ...
                    <div class="btn btn-primary btn-copy float-right" data-action="copy_products" data-name="products_id" @click="$store.page.copyItem($event.target)">
                        {!! $word['copy'] !!}
                    </div>
                    {!! Form::open(['route' => ['products.destroy', ''], 'method' => 'delete', '@submit.prevent = $store.page.deletedItems($event.target)']) !!}
