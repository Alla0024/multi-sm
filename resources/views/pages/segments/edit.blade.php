...
@section('content')
    <section class="content-header edit-container">
        @include('components.basic.head-form', ['data' => $segment])
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($segment, ['route' => ['segments.update', $segment->id], 'method' => 'patch', 'novalidate']) !!}
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('segments.index') }}" class="btn btn-default"> {{ $word['cancel'] }}</a>
            </div>
