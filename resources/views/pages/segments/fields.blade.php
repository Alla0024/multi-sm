            ...
            <tr>
                <form class="search-form" method="GET" action="">
                    ...
                    <th class="" >
                        ...
                        <div class="">
                            <input type="text" name="search_model" placeholder="Пошук по моделі" value="{{ request('search_model') }}">
                        </div>
                    </th>
                    ...
                    <th class="" >
                        ...
                        <div class="">
                            <input type="text" name="search_name" placeholder="Пошук по назві" value="{{ request('search_name') }}">
                        </div>
                    </th>
                    ...
                    <th class="" >
                        ...
                        <div class="">
                            <select id="filter_segment"  name="filter_segment" >
                    ...
                    <th class="" >
                        ...
                        <div class="">
                            <input type="text" name="search_manufacturer_id" placeholder="Пошук по назві" value="{{ request('search_name') }}">
                        </div>
                    </th>
                    ...
                    <th class="" >
                        ...
                        <div class="">
                            <input type="text" name="search_category_id" placeholder="Пошук по назві" value="{{ request('search_name') }}">
                        </div>
                    </th>
                    ...
                    <th class="" style="width: 132px">
                        ...
                        <div class="">
                            <select class="" name="filter_status"  aria-describedby="select-addon">
                    ...
                    <th class="" >
                        <div class="search-name-input">Статус</div>
                        <div class="">
                            <select class="" name="filter_stock_status"  aria-describedby="select-addon">
                    ...
                    <th class="butt-action action-item">
                        <div class="butt-action-block">
                            ...
                            <div class="action-block-search">
                                ...
                                <button type="submit" style="margin: 0 auto 6px" class="btn btn-primary  search-change-butt"
                                                 id="add_product_to_segment">Додати
                                </button>
                                <button type="submit" class="btn btn-primary  search-change-butt"
            ...
            @isset($products)
                @foreach($products as $product)
                    <tr @if($product->stock_status_id==9)style="background: #9a9ea4" @endif>
                        ...
                        <td>
                                                            <span id="status_enable_{{$product->id}}"
                                                                  class="badge @if(!$product->status) hidden @endif badge-success">Увімкнено</span>
                            <span id="status_disable_{{$product->id}}"
                                  class="badge @if($product->status) hidden @endif badge-secondary">Вимкнено</span>

                        </td>

                        <td>
                            <span class="badge @if($product->stock_status_id !== 7)badge-danger @else  badge-success  @endif ">{{$stockStatusesDescription[$product->stock_status_id]['description']['name']}}</span>
                        </td>
