...
@section('content')
    <section class="content-header edit-container">
        @include('components.basic.head-form', ['data' => $shippingMethod])
    </section>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($shippingMethod, ['route' => ['shippingMethods.update', $shippingMethod->id], 'method' => 'patch', 'novalidate']) !!}
            ...
            <div class="card-body">
                ...
                <div class="row card-items">
                    @include('pages.shipping_methods.fields')
                </div>
            </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('shippingMethods.index') }}" class="btn btn-default"> {{ $word['cancel'] }}</a>
            </div>
