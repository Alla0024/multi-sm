...
@section('content')
    <section class="content-header create-container">
        @include('components.basic.head-form', ['data' => $stockStatus ?? null])
    </section>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row card-items">
                    @include('pages.stock_statuses.fields')
                </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('stockStatuses.index') }}" class="btn btn-default">{{ $word['cancel'] }}</a>
            </div>
