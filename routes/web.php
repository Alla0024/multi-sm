...
//        Route::resource('attribute_icons', 'Content\AttributeIconController');
        ...
        Route::resource('productReviews', 'App\Http\Controllers\Content\ProductReviewController');
        Route::resource('sales', 'App\Http\Controllers\Content\SaleController');
        Route::resource('saleGroups', 'App\Http\Controllers\Content\SaleGroupController');
        ...
        Route::get('api/getSegments', 'App\Http\Controllers\Content\ApiController@getSegments')->name('getSegments');
        ...
        Route::group(['prefix' => 'api'], function () {
            ...
            Route::get('generateProductPriceSortOrder', 'App\Http\Controllers\Content\ApiController@generateProductPriceSortOrder')->name('generateProductPriceSortOrder');
